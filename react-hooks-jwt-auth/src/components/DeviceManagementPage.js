...
//   const [selectedDevice, setSelectedDevice] = useState(null); // Add state to store selected device
...
//             <input type="date" className="form-control" id="endOfSupportDate" name="endOfSupportDate" value={newDevice.supportEndDate} onChange={handleInputChange} required />
//           </div>
//           <div className="mb-3">
